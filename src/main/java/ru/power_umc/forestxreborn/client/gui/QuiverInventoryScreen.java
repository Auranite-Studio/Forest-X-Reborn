...
public class QuiverInventoryScreen extends AbstractContainerScreen<QuiverInventoryMenu> {
	private final static HashMap<String, Object> guistate = QuiverInventoryMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public QuiverInventoryScreen(QuiverInventoryMenu container, Inventory inventory, Component text) {
