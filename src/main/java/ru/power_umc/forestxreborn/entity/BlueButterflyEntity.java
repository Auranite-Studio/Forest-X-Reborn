...
public class BlueButterflyEntity extends PathfinderMob implements GeoEntity {
	...
	protected void defineSynchedData(SynchedEntityData.Builder builder) {
		...
		builder.define(TEXTURE, "blue_butterfly");
	}
	...
	public static void init(RegisterSpawnPlacementsEvent event) {
		event.register(ForestModEntities.BLUE_BUTTERFLY.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
