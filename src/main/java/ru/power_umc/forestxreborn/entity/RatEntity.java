...
public class RatEntity extends Animal implements GeoEntity {
	...
	protected void defineSynchedData(SynchedEntityData.Builder builder) {
		...
		builder.define(TEXTURE, "gray_rat");
	}
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(3, new FollowMobGoal(this, 1, (float) 16, (float) 4));
		this.goalSelector.addGoal(4, new TemptGoal(this, 1, Ingredient.of(Blocks.WHEAT.asItem()), false));
		this.goalSelector.addGoal(5, new TemptGoal(this, 1, Ingredient.of(ForestModItems.RYE.get()), false));
	...
	public SoundEvent getAmbientSound() {
		return BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse("forest:rat.ambient"));
	}

	@Override
	public SoundEvent getHurtSound(DamageSource ds) {
		return BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse("forest:rat.hurt"));
	}
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		RatEntity retval = ForestModEntities.RAT.get().create(serverWorld);
	...
	public static void init(RegisterSpawnPlacementsEvent event) {
		event.register(ForestModEntities.RAT.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(RatEntity.RemovalReason.KILLED);
