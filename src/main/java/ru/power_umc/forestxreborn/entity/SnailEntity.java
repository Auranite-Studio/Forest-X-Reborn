...
import ru.power_umc.forestxreborn.procedures.SnailRamkaghranitsaSploshnaiaProcedure;
...
public class SnailEntity extends Animal implements GeoEntity {
	...
	public boolean canBeCollidedWith() {
		...
		return SnailRamkaghranitsaSploshnaiaProcedure.execute(entity);
	}
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		SnailEntity retval = ForestModEntities.SNAIL.get().create(serverWorld);
	...
	public static void init(RegisterSpawnPlacementsEvent event) {
		event.register(ForestModEntities.SNAIL.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
