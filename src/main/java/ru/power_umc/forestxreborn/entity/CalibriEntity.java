...
public class CalibriEntity extends Animal implements GeoEntity {
	...
	protected void defineSynchedData(SynchedEntityData.Builder builder) {
		...
		builder.define(TEXTURE, "calibri");
	}
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(4, new FollowMobGoal(this, 1, (float) 16, (float) 8));
	...
	public SoundEvent getAmbientSound() {
		return BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse("forest:calibri.ambient"));
	}

	@Override
	public SoundEvent getHurtSound(DamageSource ds) {
		return BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse("forest:calibri.hurt"));
	}
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		CalibriEntity retval = ForestModEntities.CALIBRI.get().create(serverWorld);
	...
	public boolean isFood(ItemStack stack) {
		return List.of(ForestModItems.BLUEBERRY.get(), ForestModItems.BLACK_MULBERRY.get(), ForestModItems.WHITE_MULBERRY.get(), ForestModItems.RASPBERRY.get(), Items.SWEET_BERRIES).contains(stack.getItem());
	}
	...
	public static void init(RegisterSpawnPlacementsEvent event) {
		event.register(ForestModEntities.CALIBRI.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
