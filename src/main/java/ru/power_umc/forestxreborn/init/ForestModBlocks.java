...
public class ForestModBlocks {
	...
	public static final DeferredBlock<Block> WILDFLOWER = REGISTRY.register("wildflower", WildflowerBlock::new);
	public static final DeferredBlock<Block> LAVANDER = REGISTRY.register("lavander", LavanderBlock::new);
	public static final DeferredBlock<Block> BURNING_BLOSSOM = REGISTRY.register("burning_blossom", BurningblossomBlock::new);
	public static final DeferredBlock<Block> CRUSHED_SANDSTONE = REGISTRY.register("crushed_sandstone", CrushedSandstoneBlock::new);
	public static final DeferredBlock<Block> RED_CRUSHED_SANDSTONE = REGISTRY.register("red_crushed_sandstone", RedCrushedSandstoneBlock::new);
	public static final DeferredBlock<Block> CRUSHED_SANDSTONE_STAIRS = REGISTRY.register("crushed_sandstone_stairs", CrushedSandstoneStairsBlock::new);
	public static final DeferredBlock<Block> CRUSHED_SANDSTONE_SLAB = REGISTRY.register("crushed_sandstone_slab", CrushedSandstoneSlabBlock::new);
	public static final DeferredBlock<Block> CRUSHED_SANDSTONE_WALL = REGISTRY.register("crushed_sandstone_wall", CrushedSandstoneWallBlock::new);
	public static final DeferredBlock<Block> RED_CRUSHED_SANDSTONE_STAIRS = REGISTRY.register("red_crushed_sandstone_stairs", RedCrushedSandstoneStairsBlock::new);
	public static final DeferredBlock<Block> RED_CRUSHED_SANDSTONE_SLAB = REGISTRY.register("red_crushed_sandstone_slab", RedCrushedSandstoneSlabBlock::new);
	public static final DeferredBlock<Block> RED_CRUSHED_SANDSTONE_WALL = REGISTRY.register("red_crushed_sandstone_wall", RedCrushedSandstoneWallBlock::new);
	...
	public static final DeferredBlock<Block> SNAIL_SHELL = REGISTRY.register("snail_shell", SnailShellBlock::new);
	public static final DeferredBlock<Block> OAK_PARQUET = REGISTRY.register("oak_parquet", OakParquetBlock::new);
	public static final DeferredBlock<Block> BIRCH_PARQUET = REGISTRY.register("birch_parquet", BirchParquetBlock::new);
	public static final DeferredBlock<Block> SPRUCE_PARQUET = REGISTRY.register("spruce_parquet", SpruceParquetBlock::new);
	public static final DeferredBlock<Block> ACACIA_PARQUET = REGISTRY.register("acacia_parquet", AcaciaParquetBlock::new);
	public static final DeferredBlock<Block> TROPICAL_PARQUET = REGISTRY.register("tropical_parquet", TropicalParquetBlock::new);
	public static final DeferredBlock<Block> CRIMSON_PARQUET = REGISTRY.register("crimson_parquet", CrimsonParquetBlock::new);
	public static final DeferredBlock<Block> WARPED_PARQUET = REGISTRY.register("warped_parquet", WarpedParquetBlock::new);
	...
	public static final DeferredBlock<Block> MARBLE_BRICKS_SLAB = REGISTRY.register("marble_bricks_slab", MarbleBricksSlabBlock::new);
	...
	public static final DeferredBlock<Block> MARBLE_BRICKS_STAIRS = REGISTRY.register("marble_bricks_stairs", MarbleBricksStairsBlock::new);
	public static final DeferredBlock<Block> RAW_SILVER_BLOCK = REGISTRY.register("raw_silver_block", RawSilverBlockBlock::new);
	public static final DeferredBlock<Block> DARK_OAK_PARQUET = REGISTRY.register("dark_oak_parquet", DarkOakParquetBlock::new);
	public static final DeferredBlock<Block> DESERT_ROSE = REGISTRY.register("desert_rose", DesertRoseBlock::new);
	public static final DeferredBlock<Block> MANGROVE_PARQUET = REGISTRY.register("mangrove_parquet", MangroveParquetBlock::new);
	public static final DeferredBlock<Block> DENSE_WEB = REGISTRY.register("dense_web", DenseWebBlock::new);
	public static final DeferredBlock<Block> DENSE_WEB_WITH_SPIDER = REGISTRY.register("dense_web_with_spider", DenseWebWithSpiderBlock::new);
	...
	public static final DeferredBlock<Block> SANDSLATE = REGISTRY.register("sandslate", SandslateBlock::new);
	public static final DeferredBlock<Block> CHISELED_RHYOLITE = REGISTRY.register("chiseled_rhyolite", ChiseledRhyoliteBlock::new);
	public static final DeferredBlock<Block> MARBLE_BRICKS_WALL = REGISTRY.register("marble_bricks_wall", MarbleBricksWallBlock::new);
	...
	public static final DeferredBlock<Block> BLUEBERRY_BUSH_0 = REGISTRY.register("blueberry_bush_0", BlueberryBush0Block::new);
	...
	public static final DeferredBlock<Block> PUMICE_BRICKS = REGISTRY.register("pumice_bricks", PumiceBricksBlock::new);
	public static final DeferredBlock<Block> LETTUCE_STAGE_0 = REGISTRY.register("lettuce_stage_0", LettuceStage0Block::new);
	public static final DeferredBlock<Block> LETTUCE_STAGE_1 = REGISTRY.register("lettuce_stage_1", LettuceStage1Block::new);
	public static final DeferredBlock<Block> LETTUCE_STAGE_2 = REGISTRY.register("lettuce_stage_2", LettuceStage2Block::new);
	public static final DeferredBlock<Block> LETTUCE_STAGE_3 = REGISTRY.register("lettuce_stage_3", LettuceStage3Block::new);
	public static final DeferredBlock<Block> POLISHED_SANDSLATE = REGISTRY.register("polished_sandslate", PolishedSandslateBlock::new);
	public static final DeferredBlock<Block> SANDSLATE_FACETED_BRICKS = REGISTRY.register("sandslate_faceted_bricks", SandslateFacetedBricksBlock::new);
	public static final DeferredBlock<Block> COBBLED_SANDSLATE = REGISTRY.register("cobbled_sandslate", CobbledSandslateBlock::new);
	public static final DeferredBlock<Block> TRUNCATED_PUMICE = REGISTRY.register("truncated_pumice", TruncatedPumiceBlock::new);
	public static final DeferredBlock<Block> TRUNCATED_CARVED_PUMICE = REGISTRY.register("truncated_carved_pumice", TruncatedCarvedPumiceBlock::new);
	public static final DeferredBlock<Block> SANDSLATE_BRICKS = REGISTRY.register("sandslate_bricks", SandslateBricksBlock::new);
	...
	public static final DeferredBlock<Block> RHYOLITE_BRICKS_SLAB = REGISTRY.register("rhyolite_bricks_slab", RhyoliteBricksSlabBlock::new);
	public static final DeferredBlock<Block> RHYOLITE_BRICKS_STAIRS = REGISTRY.register("rhyolite_bricks_stairs", RhyoliteBricksStairsBlock::new);
	...
	public static final DeferredBlock<Block> RHYOLITE_BRICKS_WALL = REGISTRY.register("rhyolite_bricks_wall", RhyoliteBricksWallBlock::new);
	...
	public static final DeferredBlock<Block> PUMICE_BRICKS_SLAB = REGISTRY.register("pumice_bricks_slab", PumiceBricksSlabBlock::new);
	public static final DeferredBlock<Block> PUMICE_BRICKS_STAIRS = REGISTRY.register("pumice_bricks_stairs", PumiceBricksStairsBlock::new);
	public static final DeferredBlock<Block> PUMICE_BRICKS_WALL = REGISTRY.register("pumice_bricks_wall", PumiceBricksWallBlock::new);
	public static final DeferredBlock<Block> TRUNCATED_PUMICE_SLAB = REGISTRY.register("truncated_pumice_slab", TruncatedPumiceSlabBlock::new);
	public static final DeferredBlock<Block> TRUNCATED_PUMICE_STAIRS = REGISTRY.register("truncated_pumice_stairs", TruncatedPumiceStairsBlock::new);
	public static final DeferredBlock<Block> TRUNCATED_PUMICE_WALL = REGISTRY.register("truncated_pumice_wall", TruncatedPumiceWallBlock::new);
	...
	public static final DeferredBlock<Block> COBBLED_SANDSLATE_SLAB = REGISTRY.register("cobbled_sandslate_slab", CobbledSandslateSlabBlock::new);
	public static final DeferredBlock<Block> COBBLED_SANDSLATE_STAIRS = REGISTRY.register("cobbled_sandslate_stairs", CobbledSandslateStairsBlock::new);
	public static final DeferredBlock<Block> COBBLED_SANDSLATE_WALL = REGISTRY.register("cobbled_sandslate_wall", CobbledSandslateWallBlock::new);
	public static final DeferredBlock<Block> POLISHED_SANDSLATE_SLAB = REGISTRY.register("polished_sandslate_slab", PolishedSandslateSlabBlock::new);
	public static final DeferredBlock<Block> POLISHED_SANDSLATE_STAIRS = REGISTRY.register("polished_sandslate_stairs", PolishedSandslateStairsBlock::new);
	public static final DeferredBlock<Block> POLISHED_SANDSLATE_WALL = REGISTRY.register("polished_sandslate_wall", PolishedSandslateWallBlock::new);
	public static final DeferredBlock<Block> SANDSLATE_BRICKS_SLAB = REGISTRY.register("sandslate_bricks_slab", SandslateBricksSlabBlock::new);
	public static final DeferredBlock<Block> SANDSLATE_BRICKS_STAIRS = REGISTRY.register("sandslate_bricks_stairs", SandslateBricksStairsBlock::new);
	public static final DeferredBlock<Block> SANDSLATE_BRICKS_WALL = REGISTRY.register("sandslate_bricks_wall", SandslateBricksWallBlock::new);
	public static final DeferredBlock<Block> GINGERBREAD_BLOCK = REGISTRY.register("gingerbread_block", GingerbreadBlockBlock::new);
	public static final DeferredBlock<Block> RAW_GINGERBREAD_BLOCK = REGISTRY.register("raw_gingerbread_block", RawGingerbreadBlockBlock::new);
	public static final DeferredBlock<Block> GINGERBREAD_BRICKS = REGISTRY.register("gingerbread_bricks", GingerbreadBricksBlock::new);
	public static final DeferredBlock<Block> BLUE_ROSE = REGISTRY.register("blue_rose", BlueRoseBlock::new);
	public static final DeferredBlock<Block> SUNSHROOM = REGISTRY.register("sunshroom", SunshroomBlock::new);
	public static final DeferredBlock<Block> MOONSHROOM = REGISTRY.register("moonshroom", MoonshroomBlock::new);
	...
	public static final DeferredBlock<Block> EUCALYPTUS_PARQUET = REGISTRY.register("eucalyptus_parquet", EucalyptusParquetBlock::new);
	public static final DeferredBlock<Block> CHERRY_PARQUET = REGISTRY.register("cherry_parquet", CherryParquetBlock::new);
	...
	public static final DeferredBlock<Block> BLACK_FENCE = REGISTRY.register("black_fence", BlackFenceBlock::new);
	public static final DeferredBlock<Block> BLUE_FENCE = REGISTRY.register("blue_fence", BlueFenceBlock::new);
	public static final DeferredBlock<Block> BROWN_FENCE = REGISTRY.register("brown_fence", BrownFenceBlock::new);
	public static final DeferredBlock<Block> CYAN_FENCE = REGISTRY.register("cyan_fence", CyanFenceBlock::new);
	public static final DeferredBlock<Block> GRAY_FENCE = REGISTRY.register("gray_fence", GrayFenceBlock::new);
	public static final DeferredBlock<Block> GREEN_FENCE = REGISTRY.register("green_fence", GreenFenceBlock::new);
	public static final DeferredBlock<Block> LIGHT_BLUE_FENCE = REGISTRY.register("light_blue_fence", LightBlueFenceBlock::new);
	public static final DeferredBlock<Block> LIGHT_GRAY_FENCE = REGISTRY.register("light_gray_fence", LightGrayFenceBlock::new);
	public static final DeferredBlock<Block> LIME_FENCE = REGISTRY.register("lime_fence", LimeFenceBlock::new);
	public static final DeferredBlock<Block> MAGENTA_FENCE = REGISTRY.register("magenta_fence", MagentaFenceBlock::new);
	public static final DeferredBlock<Block> ORANGE_FENCE = REGISTRY.register("orange_fence", OrangeFenceBlock::new);
	public static final DeferredBlock<Block> PINK_FENCE = REGISTRY.register("pink_fence", PinkFenceBlock::new);
	public static final DeferredBlock<Block> PURPLE_FENCE = REGISTRY.register("purple_fence", PurpleFenceBlock::new);
	public static final DeferredBlock<Block> RED_FENCE = REGISTRY.register("red_fence", RedFenceBlock::new);
	public static final DeferredBlock<Block> WHITE_FENCE = REGISTRY.register("white_fence", WhiteFenceBlock::new);
	public static final DeferredBlock<Block> YELLOW_FENCE = REGISTRY.register("yellow_fence", YellowFenceBlock::new);
	public static final DeferredBlock<Block> BLACK_FENCE_GATE = REGISTRY.register("black_fence_gate", BlackFenceGateBlock::new);
	public static final DeferredBlock<Block> BLUE_FENCE_GATE = REGISTRY.register("blue_fence_gate", BlueFenceGateBlock::new);
	public static final DeferredBlock<Block> BROWN_FENCE_GATE = REGISTRY.register("brown_fence_gate", BrownFenceGateBlock::new);
	public static final DeferredBlock<Block> CYAN_FENCE_GATE = REGISTRY.register("cyan_fence_gate", CyanFenceGateBlock::new);
	public static final DeferredBlock<Block> GRAY_FENCE_GATE = REGISTRY.register("gray_fence_gate", GrayFenceGateBlock::new);
	public static final DeferredBlock<Block> GREEN_FENCE_GATE = REGISTRY.register("green_fence_gate", GreenFenceGateBlock::new);
	...
	public static final DeferredBlock<Block> LIGHT_GRAY_FENCE_GATE = REGISTRY.register("light_gray_fence_gate", LightGrayFenceGateBlock::new);
	public static final DeferredBlock<Block> LIME_FENCE_GATE = REGISTRY.register("lime_fence_gate", LimeFenceGateBlock::new);
	public static final DeferredBlock<Block> MAGENTA_FENCE_GATE = REGISTRY.register("magenta_fence_gate", MagentaFenceGateBlock::new);
	public static final DeferredBlock<Block> ORANGE_FENCE_GATE = REGISTRY.register("orange_fence_gate", OrangeFenceGateBlock::new);
	public static final DeferredBlock<Block> PINK_FENCE_GATE = REGISTRY.register("pink_fence_gate", PinkFenceGateBlock::new);
	public static final DeferredBlock<Block> PURPLE_FENCE_GATE = REGISTRY.register("purple_fence_gate", PurpleFenceGateBlock::new);
	public static final DeferredBlock<Block> RED_FENCE_GATE = REGISTRY.register("red_fence_gate", RedFenceGateBlock::new);
	public static final DeferredBlock<Block> WHITE_FENCE_GATE = REGISTRY.register("white_fence_gate", WhiteFenceGateBlock::new);
	public static final DeferredBlock<Block> YELLOW_FENCE_GATE = REGISTRY.register("yellow_fence_gate", YellowFenceGateBlock::new);
	public static final DeferredBlock<Block> BLACK_STAIRS = REGISTRY.register("black_stairs", BlackStairsBlock::new);
	public static final DeferredBlock<Block> BLUE_STAIRS = REGISTRY.register("blue_stairs", BlueStairsBlock::new);
	public static final DeferredBlock<Block> BROWN_STAIRS = REGISTRY.register("brown_stairs", BrownStairsBlock::new);
	public static final DeferredBlock<Block> CYAN_STAIRS = REGISTRY.register("cyan_stairs", CyanStairsBlock::new);
	public static final DeferredBlock<Block> GRAY_STAIRS = REGISTRY.register("gray_stairs", GrayStairsBlock::new);
	public static final DeferredBlock<Block> GREEN_STAIRS = REGISTRY.register("green_stairs", GreenStairsBlock::new);
	public static final DeferredBlock<Block> LIGHT_BLUE_STAIRS = REGISTRY.register("light_blue_stairs", LightBlueStairsBlock::new);
	public static final DeferredBlock<Block> LIGHT_GRAY_STAIRS = REGISTRY.register("light_gray_stairs", LightGrayStairsBlock::new);
	public static final DeferredBlock<Block> LIME_STAIRS = REGISTRY.register("lime_stairs", LimeStairsBlock::new);
	public static final DeferredBlock<Block> MAGENTA_STAIRS = REGISTRY.register("magenta_stairs", MagentaStairsBlock::new);
	public static final DeferredBlock<Block> ORANGE_STAIRS = REGISTRY.register("orange_stairs", OrangeStairsBlock::new);
	public static final DeferredBlock<Block> PINK_STAIRS = REGISTRY.register("pink_stairs", PinkStairsBlock::new);
	public static final DeferredBlock<Block> PURPLE_STAIRS = REGISTRY.register("purple_stairs", PurpleStairsBlock::new);
	public static final DeferredBlock<Block> RED_STAIRS = REGISTRY.register("red_stairs", RedStairsBlock::new);
	public static final DeferredBlock<Block> WHITE_STAIRS = REGISTRY.register("white_stairs", WhiteStairsBlock::new);
	public static final DeferredBlock<Block> YELLOW_STAIRS = REGISTRY.register("yellow_stairs", YellowStairsBlock::new);
	public static final DeferredBlock<Block> BLACK_SLAB = REGISTRY.register("black_slab", BlackSlabBlock::new);
	public static final DeferredBlock<Block> BLUE_SLAB = REGISTRY.register("blue_slab", BlueSlabBlock::new);
	public static final DeferredBlock<Block> BROWN_SLAB = REGISTRY.register("brown_slab", BrownSlabBlock::new);
	public static final DeferredBlock<Block> CYAN_SLAB = REGISTRY.register("cyan_slab", CyanSlabBlock::new);
	public static final DeferredBlock<Block> GRAY_SLAB = REGISTRY.register("gray_slab", GraySlabBlock::new);
	public static final DeferredBlock<Block> GREEN_SLAB = REGISTRY.register("green_slab", GreenSlabBlock::new);
	public static final DeferredBlock<Block> LIGHT_BLUE_SLAB = REGISTRY.register("light_blue_slab", LightBlueSlabBlock::new);
	public static final DeferredBlock<Block> LIGHT_GRAY_SLAB = REGISTRY.register("light_gray_slab", LightGraySlabBlock::new);
	public static final DeferredBlock<Block> LIME_SLAB = REGISTRY.register("lime_slab", LimeSlabBlock::new);
	public static final DeferredBlock<Block> MAGENTA_SLAB = REGISTRY.register("magenta_slab", MagentaSlabBlock::new);
	public static final DeferredBlock<Block> ORANGE_SLAB = REGISTRY.register("orange_slab", OrangeSlabBlock::new);
	public static final DeferredBlock<Block> PINK_SLAB = REGISTRY.register("pink_slab", PinkSlabBlock::new);
	public static final DeferredBlock<Block> PURPLE_SLAB = REGISTRY.register("purple_slab", PurpleSlabBlock::new);
	public static final DeferredBlock<Block> RED_SLAB = REGISTRY.register("red_slab", RedSlabBlock::new);
	public static final DeferredBlock<Block> WHITE_SLAB = REGISTRY.register("white_slab", WhiteSlabBlock::new);
	public static final DeferredBlock<Block> YELLOW_SLAB = REGISTRY.register("yellow_slab", YellowSlabBlock::new);
	...
	public static final DeferredBlock<Block> GRAPE_VINE_0 = REGISTRY.register("grape_vine_0", GrapeVine0Block::new);
	public static final DeferredBlock<Block> GRAPE_VINE_1 = REGISTRY.register("grape_vine_1", GrapeVine1Block::new);
	public static final DeferredBlock<Block> ASH_BLOCK = REGISTRY.register("ash_block", AshBlockBlock::new);
	public static final DeferredBlock<Block> ASH_COVER = REGISTRY.register("ash_cover", AshCoverBlock::new);
	public static final DeferredBlock<Block> FERMENTATION_BARREL = REGISTRY.register("fermentation_barrel", FermentationBarrelBlock::new);
	public static final DeferredBlock<Block> BROWN_BEAR_CARPET = REGISTRY.register("brown_bear_carpet", BrownBearCarpetBlock::new);
	public static final DeferredBlock<Block> POLAR_BEAR_CARPET = REGISTRY.register("polar_bear_carpet", PolarBearCarpetBlock::new);
	public static final DeferredBlock<Block> WHITE_ROSE_BUSH = REGISTRY.register("white_rose_bush", WhiteRoseBushBlock::new);
	public static final DeferredBlock<Block> PINK_ROSE_BUSH = REGISTRY.register("pink_rose_bush", PinkRoseBushBlock::new);
	public static final DeferredBlock<Block> MULBERRY_WOOD = REGISTRY.register("mulberry_wood", MulberryWoodBlock::new);
	public static final DeferredBlock<Block> MULBERRY_LOG = REGISTRY.register("mulberry_log", MulberryLogBlock::new);
	public static final DeferredBlock<Block> MULBERRY_PLANKS = REGISTRY.register("mulberry_planks", MulberryPlanksBlock::new);
	public static final DeferredBlock<Block> MULBERRY_STAIRS = REGISTRY.register("mulberry_stairs", MulberryStairsBlock::new);
	public static final DeferredBlock<Block> MULBERRY_SLAB = REGISTRY.register("mulberry_slab", MulberrySlabBlock::new);
	public static final DeferredBlock<Block> MULBERRY_FENCE = REGISTRY.register("mulberry_fence", MulberryFenceBlock::new);
	public static final DeferredBlock<Block> MULBERRY_FENCE_GATE = REGISTRY.register("mulberry_fence_gate", MulberryFenceGateBlock::new);
	public static final DeferredBlock<Block> MULBERRY_PRESSURE_PLATE = REGISTRY.register("mulberry_pressure_plate", MulberryPressurePlateBlock::new);
	public static final DeferredBlock<Block> MULBERRY_BUTTON = REGISTRY.register("mulberry_button", MulberryButtonBlock::new);
	public static final DeferredBlock<Block> MULBERRY_SAPLING = REGISTRY.register("mulberry_sapling", MulberrySaplingBlock::new);
	public static final DeferredBlock<Block> MULBERRY_LEAVES_WITHOUT_WHITE = REGISTRY.register("mulberry_leaves_without_white", MulberryLeavesWithoutWhiteBlock::new);
	public static final DeferredBlock<Block> MULBERRY_LEAVES_WITHOUT_BLACK = REGISTRY.register("mulberry_leaves_without_black", MulberryLeavesWithoutBlackBlock::new);
	public static final DeferredBlock<Block> MULBERRY_LEAVES_WITH_WHITE = REGISTRY.register("mulberry_leaves_with_white", MulberryLeavesWithWhiteBlock::new);
	public static final DeferredBlock<Block> MULBERRY_LEAVES_WITH_BLACK = REGISTRY.register("mulberry_leaves_with_black", MulberryLeavesWithBlackBlock::new);
	public static final DeferredBlock<Block> MULBERRY_PARQUET = REGISTRY.register("mulberry_parquet", MulberryParquetBlock::new);
	public static final DeferredBlock<Block> MULBERRY_DOOR = REGISTRY.register("mulberry_door", MulberryDoorBlock::new);
	public static final DeferredBlock<Block> MULBERRY_TRAPDOOR = REGISTRY.register("mulberry_trapdoor", MulberryTrapdoorBlock::new);
	public static final DeferredBlock<Block> STRIPPED_MULBERRY_WOOD = REGISTRY.register("stripped_mulberry_wood", StrippedMulberryWoodBlock::new);
	public static final DeferredBlock<Block> STRIPPED_MULBERRY_LOG = REGISTRY.register("stripped_mulberry_log", StrippedMulberryLogBlock::new);
	public static final DeferredBlock<Block> RASPBERRY_BUSH_0 = REGISTRY.register("raspberry_bush_0", RaspberryBush0Block::new);
	public static final DeferredBlock<Block> RASPBERRY_BUSH_1 = REGISTRY.register("raspberry_bush_1", RaspberryBush1Block::new);
	public static final DeferredBlock<Block> RASPBERRY_BUSH_2 = REGISTRY.register("raspberry_bush_2", RaspberryBush2Block::new);
	public static final DeferredBlock<Block> RASPBERRY_BUSH_3 = REGISTRY.register("raspberry_bush_3", RaspberryBush3Block::new);
	public static final DeferredBlock<Block> CATTAIL = REGISTRY.register("cattail", CattailBlock::new);
	public static final DeferredBlock<Block> RYE_STAGE_0 = REGISTRY.register("rye_stage_0", RyeStage0Block::new);
	public static final DeferredBlock<Block> RYE_STAGE_1 = REGISTRY.register("rye_stage_1", RyeStage1Block::new);
	public static final DeferredBlock<Block> RYE_STAGE_2 = REGISTRY.register("rye_stage_2", RyeStage2Block::new);
	public static final DeferredBlock<Block> RYE_STAGE_3 = REGISTRY.register("rye_stage_3", RyeStage3Block::new);
	public static final DeferredBlock<Block> RYE_STAGE_4 = REGISTRY.register("rye_stage_4", RyeStage4Block::new);
	public static final DeferredBlock<Block> RYE_STAGE_5 = REGISTRY.register("rye_stage_5", RyeStage5Block::new);
	public static final DeferredBlock<Block> RYE_STAGE_6 = REGISTRY.register("rye_stage_6", RyeStage6Block::new);
	public static final DeferredBlock<Block> RYE_STAGE_7 = REGISTRY.register("rye_stage_7", RyeStage7Block::new);
