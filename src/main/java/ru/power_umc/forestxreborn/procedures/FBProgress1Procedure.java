...
public class FBProgress1Procedure {
	public static boolean execute(LevelAccessor world, double x, double y, double z) {
		...
		if (getBlockNBTNumber(world, BlockPos.containing(x, y, z), "craftingProgress") > craftingTime && getBlockNBTNumber(world, BlockPos.containing(x, y, z), "craftingProgress") <= craftingTime * 2) {
			return true;
		}
		return false;
	}
