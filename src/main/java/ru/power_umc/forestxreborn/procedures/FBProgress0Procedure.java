...
public class FBProgress0Procedure {
	public static boolean execute(LevelAccessor world, double x, double y, double z) {
		double craftingTime = 0;
		craftingTime = getBlockNBTNumber(world, BlockPos.containing(x, y, z), "craftingTime") / 10;
		if (getBlockNBTNumber(world, BlockPos.containing(x, y, z), "craftingProgress") > 0 && getBlockNBTNumber(world, BlockPos.containing(x, y, z), "craftingProgress") <= craftingTime) {
			return true;
		}
		return false;
	}
