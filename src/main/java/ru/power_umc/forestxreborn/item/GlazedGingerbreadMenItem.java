...
public class GlazedGingerbreadMenItem extends Item {
	public GlazedGingerbreadMenItem(Item.Properties properties) {
		super(properties.rarity(Rarity.COMMON).stacksTo(64).food((new FoodProperties.Builder()).nutrition(4).saturationModifier(0.6f).build()));
	}
	...
	public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, TooltipDisplay display, Consumer<Component> list, TooltipFlag flag) {
		...
		String hoverText = GingerbreadMenLCProcedure.execute();
		if (hoverText != null) {
