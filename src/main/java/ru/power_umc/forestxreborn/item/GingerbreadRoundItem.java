...
import ru.power_umc.forestxreborn.procedures.GingerbreadRoundLCProcedure;
...
public class GingerbreadRoundItem extends Item {
	public GingerbreadRoundItem(Item.Properties properties) {
	...
	public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, TooltipDisplay display, Consumer<Component> list, TooltipFlag flag) {
		...
		String hoverText = GingerbreadRoundLCProcedure.execute();
		if (hoverText != null) {
