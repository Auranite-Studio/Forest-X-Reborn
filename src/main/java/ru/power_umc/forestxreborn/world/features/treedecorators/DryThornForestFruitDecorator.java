...
public class DryThornForestFruitDecorator extends CocoaDecorator {
	public static MapCodec<DryThornForestFruitDecorator> CODEC = MapCodec.unit(DryThornForestFruitDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("forest:dry_thorn_forest_tree_fruit_decorator"), () -> DECORATOR_TYPE);
	}

	public DryThornForestFruitDecorator() {
		super(0.2f);
	}
