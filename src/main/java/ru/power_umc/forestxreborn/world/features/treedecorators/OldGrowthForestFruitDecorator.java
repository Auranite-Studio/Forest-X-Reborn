...
public class OldGrowthForestFruitDecorator extends CocoaDecorator {
	public static MapCodec<OldGrowthForestFruitDecorator> CODEC = MapCodec.unit(OldGrowthForestFruitDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("forest:old_growth_forest_tree_fruit_decorator"), () -> DECORATOR_TYPE);
	}

	public OldGrowthForestFruitDecorator() {
		super(0.2f);
	}
